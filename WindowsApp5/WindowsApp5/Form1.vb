Public Class Form1
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        Table1TableAdapter.Update(Database2DataSet.Table1)
    ...
    Private Sub SearchToolStripButton_Click(sender As Object, e As EventArgs) Handles SearchToolStripButton.Click
        Try
            ...
            Me.Table1TableAdapter.Search(Me.Database2DataSet.Table1, Param1)
    ...
    Private Sub Button7_Click(sender As Object, e As EventArgs) Handles Button7.Click
        Table1TableAdapter.Search(Database2DataSet.Table1, TextBox1.Text)
